/*
* s3c6410_wm8960.c  --  SoC audio for s3c6410 with WM8960
 *
...
static int set_scenario_endpoints(struct snd_soc_codec *codec, int scenario)
{
		...
		snd_soc_dapm_disable_pin(codec, "Audio Out3");
		snd_soc_dapm_disable_pin(codec, "Line In2");
		snd_soc_dapm_disable_pin(codec, "Line In3");
                break;
		...
		snd_soc_dapm_enable_pin(codec, "Audio Out3");
		snd_soc_dapm_enable_pin(codec, "Line In2");
		snd_soc_dapm_enable_pin(codec, "Line In3");
                break;
...
static const struct snd_soc_dapm_widget s3c6410_dapm_widgets[] = {
	...
	SND_SOC_DAPM_LINE("Audio Out3", NULL),
...
static const struct snd_soc_dapm_route audio_map[] = {
	...
	{"Audio Out1", NULL, "HP_R"},
        {"Audio Out2", NULL, "SPK_RN"},
        {"Audio Out2", NULL, "SPK_RP"},
        {"Audio Out3", NULL, "SPK_RN"},
        {"Audio Out3", NULL, "SPK_RP"},
	/* Connections to the GSM Module */
	{"LINPUT2", NULL, "Line In2"},
	{"RINPUT2", NULL, "Line In2"},
	{"LINPUT3", NULL, "Line In3"},
	{"RINPUT3", NULL, "Line In3"},
	{"GSM Line Out", NULL, "OUT3"},
	{"GSM Line Out", NULL, "OUT3"},
	{"LINPUT1", NULL, "GSM Line In"},
	{"RINPUT1", NULL, "GSM Line In"},
...
static int s3C6410_wm8960_init(struct snd_soc_codec *codec)
{
	int i, err;
	...
	for (i = 0; i < ARRAY_SIZE(wm8960_s3c6410_controls); i++)
	{
		err = snd_ctl_add(codec->card, snd_soc_cnew(&wm8960_s3c6410_controls[i], codec, NULL));
		if (err < 0)
			return err;
	}
...
static struct wm8960_setup_data s3c6410_wm8960_setup = {
	.i2c_bus = 0,
	.i2c_address = 0x1A,
};
...
static struct snd_soc_device s3c6410_snd_devdata = {
	...
	.codec_data = &s3c6410_wm8960_setup,
};
...
static int __init s3c6410_init(void)
{
	...
	s3c6410_snd_device = platform_device_alloc("soc-audio", 0);
